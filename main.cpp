...
int           NS, PF, N, PRECISION, WINDOW_SIZE, MIN_WINDOW_SIZE;
extern double temperature;
char          *ENERGY;
paramT        *P;

void read_input(int, char **, char **);
void usage();
...
void usage() {
  fprintf(stderr, "FFThairpin [options] sequence [options]\n\n");
  
  fprintf(stderr, "FFThairpin [options] filename [options]\n");
...
void read_input(int argc,char *argv[], char **maina) {
  FILE *infile;
